...
export const getPermalink = (slug = '', type = 'page'): string => {
  ...
  switch (type) {
    ...
    case 'projects':
      permalink = getProjectsPermalink();
      break;
    ...
    case 'project-tag':
      permalink = createPath(PROJECTS_BASE, PROJECT_TAG_BASE, trimSlash(slug));
      break;
    ...
    case 'project':
      permalink = createPath(PROJECTS_BASE, trimSlash(slug));
      break;
